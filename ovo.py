...
if entrega == "não" or "nao":
    valor= valor+0.00
elif entrega == "sim":
    valor = valor+5.00

pagamento = input ("Sua compra sera paga com pix, dinheiro ou cartão de crédito?\n(Responda com P, D ou C)")

if pagamento == "P" or "p" or "D" or "d":
    valor= valor-
elif pagamento == "C" or "c":
    valor = valor+3.30